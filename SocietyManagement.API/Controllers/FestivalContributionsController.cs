...
public class FestivalContributionsController : ApiControllerBase
{
    ...
    [ProducesResponseType(typeof(ApiResponse<PaginatedResult<FestivalContributionDto>>), StatusCodes.Status200OK)]
    ...
    [HasPermission(Permissions.Festivals.View)]
    [ProducesResponseType(typeof(ApiResponse<List<PendingContributorDto>>), StatusCodes.Status200OK)]
    ...
    [HasPermission(Permissions.Festivals.Contribute)]
    [ProducesResponseType(typeof(ApiResponse<List<ContributableFlatDto>>), StatusCodes.Status200OK)]
    ...
    [HasPermission(Permissions.Festivals.View)]
    [ProducesResponseType(typeof(ApiResponse<FlatContributionKpisDto>), StatusCodes.Status200OK)]
