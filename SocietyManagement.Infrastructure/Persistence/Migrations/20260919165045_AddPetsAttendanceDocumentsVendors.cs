...
{
    /// <inheritdoc />
    public partial class AddPetsAttendanceDocumentsVendors : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Identification = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    LastVaccinationDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    NextVaccinationDue = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Pets_Flats_FlatId",
                        column: x => x.FlatId,
                        principalTable: "Flats",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Pets_Societies_SocietyId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SocietyDocuments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SocietyDocuments_Societies_SocietyId",
                        column: x => x.SocietyId,
                        principalTable: "Societies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StaffAttendances_Societies_SocietyId",
                        column: x => x.SocietyId,
                        principalTable: "Societies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Vendors_Societies_SocietyId",
                        column: x => x.SocietyId,
                        principalTable: "Societies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Pets_SocietyId_FlatId",
                table: "Pets",
                columns: new[] { "SocietyId", "FlatId" });

            migrationBuilder.CreateIndex(
                name: "IX_SocietyDocuments_SocietyId_Category",
                table: "SocietyDocuments",
                columns: new[] { "SocietyId", "Category" });

            migrationBuilder.CreateIndex(
                name: "IX_StaffAttendances_SocietyId_Date",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Vendors_SocietyId_Category",
                table: "Vendors",
                columns: new[] { "SocietyId", "Category" });
        }
