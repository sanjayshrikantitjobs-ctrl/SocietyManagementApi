...
namespace SocietyManagement.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260919172019_AddInventoryPurchasingBudgets")]
    partial class AddInventoryPurchasingBudgets
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SocietyManagement.Domain.Entities.AnnouncementSave", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AnnouncementSaves", (string)null);
                });
            ...
            modelBuilder.Entity("SocietyManagement.Domain.Entities.FestivalBudgetCategory", b =>
                {
                    ...
                    b.HasIndex("FestivalId", "Category")
                        .IsUnique()
                        .HasFilter("[IsDeleted] = 0 AND [Category] <> 13");
            ...
            modelBuilder.Entity("SocietyManagement.Domain.Entities.MaintenanceBill", b =>
                {
                    ...
                    b.Property<bool>("IsRolledForward")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("SocietyManagement.Domain.Entities.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("UserId", "EventType", "DedupeKey")
                        .IsUnique()
            ...
            modelBuilder.Entity("SocietyManagement.Domain.Entities.ParkingFine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SocietyId", "FineDate");

                    b.ToTable("ParkingFines", (string)null);
                });
            ...
            modelBuilder.Entity("SocietyManagement.Domain.Entities.Pet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime?>("NextVaccinationDue")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("SocietyManagement.Domain.Entities.ResidentDocument", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ResidentDocuments", (string)null);
                });
            ...
            modelBuilder.Entity("SocietyManagement.Domain.Entities.Society", b =>
                {
                    ...
                    b.Property<bool>("IsSubscriptionSuspended")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("SocietyManagement.Domain.Entities.SocietyDocument", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("SocietyDocuments", (string)null);
                });
            ...
            modelBuilder.Entity("SocietyManagement.Domain.Entities.StaffAttendance", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SocietyManagement.Domain.Entities.Vendor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SocietyManagement.Domain.Entities.WaterTankerLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("NumberOfTankers")
                        .HasColumnType("int");

                    b.Property<decimal>("PricePerTanker")
                        .HasColumnType("decimal(12,2)");
                    ...
                    b.ToTable("WaterTankerLogs", (string)null);
                });
            ...
            modelBuilder.Entity("SocietyManagement.Domain.Entities.ParkingFine", b =>
                {
                    b.HasOne("SocietyManagement.Domain.Entities.User", "IssuedByUser")
                        .WithMany()
                    ...
                    b.HasOne("SocietyManagement.Domain.Entities.Vehicle", "Vehicle")
                        .WithMany()
            ...
            modelBuilder.Entity("SocietyManagement.Domain.Entities.ResidentDocument", b =>
                {
                    ...
                    b.HasOne("SocietyManagement.Domain.Entities.User", "UploadedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("SocietyManagement.Domain.Entities.SupportTicket", b =>
                {
                    ...
                    b.HasOne("SocietyManagement.Domain.Entities.User", "ResolvedByUser")
                        .WithMany()
