...
{
    /// <inheritdoc />
    public partial class AddInventoryPurchasingBudgets : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Budgets_Societies_SocietyId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InventoryItems_Societies_SocietyId",
                        column: x => x.SocietyId,
                        principalTable: "Societies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PurchaseRequests_Societies_SocietyId",
                        column: x => x.SocietyId,
                        principalTable: "Societies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LocationOfUse = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StockTransactions_Societies_SocietyId",
                        column: x => x.SocietyId,
                        principalTable: "Societies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Quantity = table.Column<decimal>(type: "decimal(12,2)", nullable: false),
                    Unit = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    EstimatedUnitPrice = table.Column<decimal>(type: "decimal(12,2)", nullable: false),
                    ReceivedQuantity = table.Column<decimal>(type: "decimal(12,2)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Budgets_SocietyId_FinancialYear_Category",
                table: "Budgets",
                columns: new[] { "SocietyId", "FinancialYear", "Category" },
                unique: true,
                filter: "[IsDeleted] = 0");

            migrationBuilder.CreateIndex(
                name: "IX_InventoryItems_SocietyId_IsActive",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseRequests_SocietyId_Status",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockTransactions_InventoryItemId_TransactionDate",
                table: "StockTransactions",
                columns: new[] { "InventoryItemId", "TransactionDate" });

            migrationBuilder.CreateIndex(
                name: "IX_StockTransactions_SocietyId",
                table: "StockTransactions",
                column: "SocietyId");
        }
