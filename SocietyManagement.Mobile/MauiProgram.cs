...
public static class MauiProgram
{
	public static MauiApp CreateMauiApp()
	{
		...
		builder.Services.AddTransient<AnnouncementsListViewModel>();
		builder.Services.AddTransient<AnnouncementsListPage>();
		builder.Services.AddTransient<AnnouncementDetailViewModel>();
		builder.Services.AddTransient<AnnouncementDetailPage>();
		builder.Services.AddTransient<AnnouncementFormViewModel>();
		builder.Services.AddTransient<AnnouncementFormPage>();
		builder.Services.AddTransient<FacilitiesListViewModel>();
		builder.Services.AddTransient<FacilitiesListPage>();
		builder.Services.AddTransient<FacilityDetailViewModel>();
		builder.Services.AddTransient<FacilityDetailPage>();
		builder.Services.AddTransient<FacilityBookingFormViewModel>();
		builder.Services.AddTransient<FacilityBookingFormPage>();
		builder.Services.AddTransient<MyFacilityBookingsViewModel>();
		builder.Services.AddTransient<MyFacilityBookingsPage>();
		builder.Services.AddTransient<AssetsListViewModel>();
		builder.Services.AddTransient<AssetsListPage>();
		builder.Services.AddTransient<MyAssetRentalsViewModel>();
		builder.Services.AddTransient<MyAssetRentalsPage>();
