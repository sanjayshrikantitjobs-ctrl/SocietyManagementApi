...
/** "Add Tenant" — the first person added becomes the Primary Tenant and
 * opens a brand-new Tenant occupancy episode (auto-closing any current one
 * server-side). Additional residents are added afterward via
 * app-add-occupancy-family-member-dialog. */
@Component({
  ...
  template: `
    ...
    <form [formGroup]="form" (ngSubmit)="submit()">
      ...
      <mat-dialog-actions align="end">
        ...
        <button mat-flat-button color="primary" type="submit" [disabled]="form.invalid">Add Tenant</button>
      </mat-dialog-actions>
    </form>
  `,
  styles: [`
...
export class AddTenantDialogComponent {
  ...
  data = inject<AddTenantDialogData>(MAT_DIALOG_DATA);
  ...
  submit(): void {
    ...
    this.occupancyService.addTenant({
